...
@Slf4j
@Service
public class BeerServiceS14Impl implements BeerServiceS14 {
    private Map<UUID, BeerDTOS14> beerMap;

    public BeerServiceS14Impl() {
        this.beerMap = new HashMap<>();

        BeerDTOS14 beer1 = BeerDTOS14.builder()
                .id(UUID.randomUUID())
                .version(1)
                .beerName("Galaxy Cat")
        ...
        BeerDTOS14 beer2 = BeerDTOS14.builder()
                .id(UUID.randomUUID())
                .version(1)
                .beerName("Crank")
                .beerStyle(BeerStyle.PALE_ALE)
        ...
        BeerDTOS14 beer3 = BeerDTOS14.builder()
                .id(UUID.randomUUID())
                .version(1)
    ...
    public Optional<BeerDTOS14> patchBeerById(UUID beerId, BeerDTOS14 beer) {
        BeerDTOS14 existing = beerMap.get(beerId);
    ...
    public BeerDTOS14 saveNewBeer(BeerDTOS14 beer) {
        ...
        BeerDTOS14 savedBeer = BeerDTOS14.builder()
                .id(UUID.randomUUID())
                .version(1)
                .createdDate(LocalDateTime.now())
                .updateDate(LocalDateTime.now())
