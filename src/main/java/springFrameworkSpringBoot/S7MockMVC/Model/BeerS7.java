...
public class BeerS7 {
    ...
    private BeerStyleS7 beerStyleS7;
    private String upc;
    ...
    BeerS7(UUID id, Integer version, String beerName, BeerStyleS7 beerStyleS7, String upc, Integer quantityOnHand, BigDecimal price, LocalDateTime createdDate, LocalDateTime updateDate) {
        this.id = id;
        this.version = version;
        this.beerName = beerName;
        this.beerStyleS7 = beerStyleS7;
        this.upc = upc;
    ...
    public BeerStyleS7 getBeerStyle() {
        return this.beerStyleS7;
    }
    ...
    public void setBeerStyle(BeerStyleS7 beerStyleS7) {
        this.beerStyleS7 = beerStyleS7;
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof BeerS7)) return false;
        final BeerS7 other = (BeerS7) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof BeerS7;
    }
    ...
    public static class BeerBuilder {
        ...
        public BeerBuilder beerStyle(BeerStyleS7 beerStyleS7) {
            this.beerStyleS7 = beerStyleS7;
            return this;
        }
        ...
        public BeerS7 build() {
            return new BeerS7(id, version, beerName, beerStyleS7, upc, quantityOnHand, price, createdDate, updateDate);
        }

        public String toString() {
            return "Beer.BeerBuilder(id=" + this.id + ", version=" + this.version + ", beerName=" + this.beerName + ", beerStyle=" + this.beerStyleS7 + ", upc=" + this.upc + ", quantityOnHand=" + this.quantityOnHand + ", price=" + this.price + ", createdDate=" + this.createdDate + ", updateDate=" + this.updateDate + ")";
        }
    }
}