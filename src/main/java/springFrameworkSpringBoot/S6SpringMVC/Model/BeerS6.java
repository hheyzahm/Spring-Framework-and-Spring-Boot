...
public class BeerS6 {
    ...
    private BeerStyleS6 beerStyleS6;
    private String upc;
    ...
    BeerS6(UUID id, Integer version, String beerName, BeerStyleS6 beerStyleS6, String upc, Integer quantityOnHand, BigDecimal price, LocalDateTime createdDate, LocalDateTime updateDate) {
        this.id = id;
        this.version = version;
        this.beerName = beerName;
        this.beerStyleS6 = beerStyleS6;
        this.upc = upc;
    ...
    public BeerStyleS6 getBeerStyle() {
        return this.beerStyleS6;
    }
    ...
    public void setBeerStyle(BeerStyleS6 beerStyleS6) {
        this.beerStyleS6 = beerStyleS6;
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof BeerS6)) return false;
        final BeerS6 other = (BeerS6) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof BeerS6;
    }
    ...
    public static class BeerBuilder {
        ...
        public BeerBuilder beerStyle(BeerStyleS6 beerStyleS6) {
            this.beerStyleS6 = beerStyleS6;
            return this;
        }
        ...
        public BeerS6 build() {
            return new BeerS6(id, version, beerName, beerStyleS6, upc, quantityOnHand, price, createdDate, updateDate);
        }

        public String toString() {
            return "Beer.BeerBuilder(id=" + this.id + ", version=" + this.version + ", beerName=" + this.beerName + ", beerStyle=" + this.beerStyleS6 + ", upc=" + this.upc + ", quantityOnHand=" + this.quantityOnHand + ", price=" + this.price + ", createdDate=" + this.createdDate + ", updateDate=" + this.updateDate + ")";
        }
    }
}