package springFrameworkSpringBoot.S9SpringDataJPAWithSpringMVC.Model;
...
public class BeerDTO {
    ...
    BeerDTO(UUID id, Integer version, String beerName, BeerStyleS9 beerStyleS9, String upc, Integer quantityOnHand, BigDecimal price, LocalDateTime createdDate, LocalDateTime updateDate) {
        this.id = id;
        this.version = version;
        this.beerName = beerName;
        this.beerStyleS9 = beerStyleS9;
        this.upc = upc;
    ...
    public BeerStyleS9 getBeerStyle() {
        return this.beerStyleS9;
    }
    ...
    public void setBeerStyle(BeerStyleS9 beerStyleS9) {
        this.beerStyleS9 = beerStyleS9;
    }
    ...
    public static class BeerBuilder {
        ...
        public BeerBuilder beerStyle(BeerStyleS9 beerStyleS9) {
            this.beerStyleS9 = beerStyleS9;
            return this;
        }
        ...
        public BeerDTO build() {
            return new BeerDTO(id, version, beerName, beerStyleS9, upc, quantityOnHand, price, createdDate, updateDate);
        }

        public String toString() {
            return "Beer.BeerBuilder(id=" + this.id + ", version=" + this.version + ", beerName=" + this.beerName + ", beerStyle=" + this.beerStyleS9 + ", upc=" + this.upc + ", quantityOnHand=" + this.quantityOnHand + ", price=" + this.price + ", createdDate=" + this.createdDate + ", updateDate=" + this.updateDate + ")";
        }
    }
}