...
public class BootstrapDataS16 implements CommandLineRunner {
    private final BeerRepositoryS16 beerRepository;
    private final CustomerRepositoryS16 customerRepository;
    private final BeerCsvServiceS16 beerCsvService;
    ...
    private void loadCsvData() throws FileNotFoundException {
        if (beerRepository.count() < 10){
            ...
            recs.forEach(beerCSVRecord -> {
                ...
                beerRepository.save(BeerEntityS16.builder()
    ...
    private void loadBeerData() {
        if (beerRepository.count() == 0){
            BeerEntityS16 beer1 = BeerEntityS16.builder()
                    .beerName("Galaxy Cat")
            ...
            BeerEntityS16 beer2 = BeerEntityS16.builder()
                    .beerName("Crank")
                    .beerStyle(BeerStyle.PALE_ALE)
                    .upc("12356222")
            ...
            BeerEntityS16 beer3 = BeerEntityS16.builder()
    ...
    private void loadCustomerData() {
        ...
        if (customerRepository.count() == 0) {
            CustomerEntityS16 customer1 = CustomerEntityS16.builder()
                    .id(UUID.randomUUID())
                    .name("Customer 1")
                    .version(1)
                    .createdDate(LocalDateTime.now())
            ...
            CustomerEntityS16 customer2 = CustomerEntityS16.builder()
                    .id(UUID.randomUUID())
                    .name("Customer 2")
                    .version(1)
                    .createdDate(LocalDateTime.now())
            ...
            CustomerEntityS16 customer3 = CustomerEntityS16.builder()
                    .id(UUID.randomUUID())
                    .name("Customer 3")
                    .version(1)
                    .createdDate(LocalDateTime.now())
