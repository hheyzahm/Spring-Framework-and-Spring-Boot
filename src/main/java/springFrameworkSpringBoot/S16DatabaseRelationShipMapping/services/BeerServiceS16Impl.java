...
@Slf4j
@Service
public class BeerServiceS16Impl implements BeerServiceS16 {

    private Map<UUID, BeerDTOS16> beerMap;

    public BeerServiceS16Impl() {
        this.beerMap = new HashMap<>();

        BeerDTOS16 beer1 = BeerDTOS16.builder()
                .id(UUID.randomUUID())
                .version(1)
                .beerName("Galaxy Cat")
        ...
        BeerDTOS16 beer2 = BeerDTOS16.builder()
                .id(UUID.randomUUID())
                .version(1)
                .beerName("Crank")
                .beerStyle(BeerStyle.PALE_ALE)
        ...
        BeerDTOS16 beer3 = BeerDTOS16.builder()
                .id(UUID.randomUUID())
                .version(1)
    ...
    public Optional<BeerDTOS16> patchBeerById(UUID beerId, BeerDTOS16 beer) {
        BeerDTOS16 existing = beerMap.get(beerId);
    ...
    @Override
    public Page<BeerDTOS16> listBeers(String beerName, BeerStyle beerStyle, Boolean showInventory, Integer pageNumber, Integer pageSize){
    ...
    public BeerDTOS16 saveNewBeer(BeerDTOS16 beer) {
        ...
        BeerDTOS16 savedBeer = BeerDTOS16.builder()
                .id(UUID.randomUUID())
                .version(1)
                .createdDate(LocalDateTime.now())
                .updateDate(LocalDateTime.now())
